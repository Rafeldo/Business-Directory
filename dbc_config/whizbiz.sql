...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 18, 2015 at 08:22 PM
...
(1, 0, 'airport', 'fa-plane', 'airport1.jpg', 0, 1, 1425378600, 1),
(2, 0, 'cafe', 'fa-coffee', 'cafe.jpg', 0, 1, 1425378640, 1),
(3, 0, 'cinemas', 'fa-ticket', 'cinemas.jpg', 0, 1, 1425378732, 1),
(4, 0, 'hotels_and_resorts', 'fa-building-o', 'resort1.jpg', 0, 1, 1425378851, 1),
(5, 0, 'libraries', 'fa-book', 'library.jpg', 0, 1, 1425378937, 1),
(6, 0, 'night_clubs', 'fa-glass', 'night_club1.jpg', 0, 1, 1425379043, 1),
(7, 0, 'offices', 'fa-briefcase', 'office.png', 0, 1, 1425379116, 1),
(8, 0, 'restaurants', 'fa-cutlery', 'restaurant.jpg', 0, 1, 1425379224, 1),
(9, 0, 'shops', 'fa-shopping-cart', 'shop.jpg', 0, 1, 1425379268, 1),
(10, 1, 'Car Rental', 'fa-car', '', 0, 1, 1450465856, 1),
(11, 1, 'Money Exchange', 'fa-money', '', 0, 1, 1450466466, 1);
...
(11, 'business_settings', '{"publish_directly":"Yes","publish_directly_rules":"required","system_currency":"ALL","system_currency_type":"0","system_currency_rules":"required","enable_signup":"Yes","enable_signup_rules":"required","hide_posts_if_expired":"No","hide_posts_if_expired_rules":"required","show_admin_agent":"Yes","show_admin_agent_rules":"required","show_street_view":"Yes","show_street_view_rules":"required","show_state_province":"no","show_state_province_rules":"required","city_dropdown":"autocomplete","city_dropdown_rules":"required","show_distance_in":"miles","show_distance_in_rules":"required","posts_per_page":"6","posts_per_page_rules":"required","currency_placing":"before_with_no_gap","currency_placing_rules":"required","enable_fb_login":"No","enable_fb_login_rules":"required","fb_app_id":"","fb_app_id_rules":"","fb_secret_key":"","fb_secret_key_rules":"","enable_comment":"No","enable_comment_rules":"required","fb_comment_app_id":"","fb_comment_app_id_rules":"","disqus_shortname":"","disqus_shortname_rules":""}', 1),
...
(31, 'Category main with subcategories', 'category_main_with_subcategories', NULL, 1, 1);
