...
<head>
    ...
    else
    {
        ...
        {
            $page_title = translate(get_settings('site_settings', 'site_title')).'|'.translate(lang_key($sub_title));
    ...
    <meta property="og:site_name" content="<?php echo get_settings('site_settings','site_title');?>" />
