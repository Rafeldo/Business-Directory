      ...
      <div class="box-content">
      		...
      		<form class="form-horizontal" id="addcategory" action="<?php echo site_url('admin/category/addcategory');?>" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-4 col-md-4 controls">
						<select class="form-control input-sm" name="parent" id="parent">
							...
							?>
							<option fav-class="<?php echo $cat->fa_icon;?>" value="<?php echo $cat->id;?>"><?php echo $cat->title;?></option>
							<?php
							}
							?>	
						</select>
				...
				<div class="form-group">
					...
					<div class="col-sm-4 col-md-4 controls">
						<input type="text" name="fa_icon" value="<?php echo(set_value('fa_icon')!='')?set_value('fa_icon'):'';?>" placeholder="<?php echo lang_key('fa-car');?>" class="form-control input-sm fav-input" >
